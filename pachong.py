...
if __name__ == "__main__":
    ...
    try:
        ...
        em.append_datas([u"行业：", u"服装鞋包", u"子行业", u"男装", u"分类", u"T恤"])
        em.append_datas([u"店铺", u"主营", u"掌柜", u"地址", u"开店时间", u"好评率", u"销售量", u"销售金额"])
        urls = []
        for i in xrange(1, 50):
            driver.get("http://www.taosj.com/industry/index.html#/data/hotshops/?cid=50000436&pcid=2&brand=&type=ALL&date=&pageNo=" + str(i))
            time.sleep(1)
    ...
    em.save("d:\\pachong_result2.xlsx")